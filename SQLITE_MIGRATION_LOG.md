...
4. **১ কোটি স্কেল বেঞ্চমার্ক — সম্পূর্ণ চালানো যায়নি এই সেশনেও, কিন্তু এবার সততার সাথে কারণসহ**: এই সেশনের sandbox-এ একটা single কমান্ড ~৫ মিনিটের বেশি চলতে পারে না, আর শুধু ইনভয়েস-ইনসার্ট ধাপই ১০ লাখে ৩৫.৩s আর ৩০ লাখে ১৮০.৯s নিয়েছে — অর্থাৎ প্রতি-রো ইনসার্ট খরচ **স্থির না, বাড়ছে** (৫০ হাজারে ~১৫.৮µs/রো → ১০ লাখে ~৩৫.৩µs/রো → ৩০ লাখে ~৬০.৩µs/রো, ইনডেক্স B-tree বড় হওয়ার স্বাভাবিক খরচ)। এই ট্রেন্ড রৈখিক না হওয়ায় সরল এক্সট্রাপোলেশন অবিশ্বাস্য — ১ কোটিতে ইনসার্ট টাইম আগে ধারণা করা "~৭ মিনিট"-এর চেয়ে বেশি হতে পারে (রুক্ষ প্রক্ষেপণ: ১২-২০ মিনিট রেঞ্জ, নিশ্চিত না)। **পরের সেশনের কাজ**: এই বেঞ্চমার্ক একটা রিয়েল মেশিনে (সময়সীমা ছাড়া) চালিয়ে আসল ১ কোটি নাম্বার কনফার্ম করা — কমান্ড: `node scripts/generate-synthetic-dataset.mjs --products=100000 --customers=10000 --invoices=10000000`।
5. **🆕 নতুন গুরুত্বপূর্ণ তথ্য — DB ফাইল সাইজ স্কেলিং**: ১০ লাখ ইনভয়েসে ৩৮৭ MB, ৩০ লাখে ১০৯০ MB (~৩৬৩ MB/মিলিয়ন, প্রায় রৈখিক)। এক্সট্রাপোলেটেড ১ কোটি ইনভয়েসে **~৩.৬ GB** DB ফাইল। বাজেট Android ফোনে (৫০০ দোকানে ছড়িয়ে) এটা storage/backup সময়ের জন্য গুরুত্বপূর্ণ বিবেচ্য বিষয় — কোনো দোকানের স্টোরেজ স্পেস এই মার্জিনের কাছাকাছি কিনা যাচাই করা উচিত ফুল রোলআউটের আগে।

### 🔴 ব্লকার — বাকি
- (Boot backfill, queryPage() keyset SEEK বাগ ও DB-সাইজ মাপা — সবকটা সমাধান হয়ে গেছে উপরে — কোনো নতুন কোড-লেভেল ব্লকার এই মুহূর্তে চিহ্নিত নেই)
- **Real-device যাচাই এখনো বাকি** — dev flag চালু করে real device-এ boot টাইম/মেমরি ব্যবহার (৬-মাস windowed invoices দিয়ে) আর keyset pagination (ফিক্সের পর) উভয়ই sandbox-এর বাইরে কখনো টেস্ট হয়নি।
- **১ কোটি স্কেল বেঞ্চমার্ক রিয়েল মেশিনে সম্পূর্ণ রান বাকি** (উপরে #৪ দ্রষ্টব্য) — ইনসার্ট টাইম ও ~৩.৬ GB ফাইল-সাইজ প্রক্ষেপণ দুটোই কনফার্ম করা দরকার।
