...
## 🎯 মাস্টার স্ট্যাটাস (এন্ট্রি ৪৩-এ আপডেট — নতুন সেশনে প্রথমে এই সেকশনটাই পড়ুন)

**🟡 এন্ট্রি ৪৩**: ধাপ ৭.১ (ব্যবহার-সাইট ক্যাটাগরাইজেশন) + ৭.২ (`useProductsByIds()` async cache hook) কোড-সম্পূর্ণ, বিল্ড+লিন্ট+টেস্ট ক্লিন। **৭.৩ (বুট সিকোয়েন্স পরিবর্তন — আসল মেমরি-সাশ্রয়) ইচ্ছাকৃতভাবে করা হয়নি** — অডিটে নতুন ব্লকার ধরা পড়েছে: ৪টা জায়গা (dup-name চেক, category-list, supplier/dosageForm distinct-list, AIPage_ forecast) এখনো পুরো `products` অ্যারে JS-স্ক্যান করে, SQL-এ না আনা পর্যন্ত বুট থেকে products সরানো ডেটা-ইন্টেগ্রিটি ঝুঁকি (ডুপ্লিকেট প্রোডাক্ট)। বিস্তারিত+পরের ক্রম এন্ট্রি ৪৩ দ্রষ্টব্য।
