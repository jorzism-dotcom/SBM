...
// 🆕 এন্ট্রি ১১৪ — কনকারেন্সি ডায়াগনস্টিক (প্রতিটা ধীর db.query() কল), মেইন-থ্রেড
// jank মনিটর (৩০ সেকেন্ড ধরে প্রতি ২ সেকেন্ডে একটা লাইন), আর DB স্বাস্থ্য-চেক
// যোগ হওয়ায় একটা বুট-সেশনেই ৬০-এর বেশি লাইন জমে যেতে পারে — পুরনো
// MAX_ENTRIES=60-এ সবচেয়ে গুরুত্বপূর্ণ প্রথম-দিকের লাইনগুলো (SQL cold-start,
// DB স্বাস্থ্য) ব্যবহারকারী কপি করার আগেই রিং-বাফার থেকে মুছে যেতে পারত।
