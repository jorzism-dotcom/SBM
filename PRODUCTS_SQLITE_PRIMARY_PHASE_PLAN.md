...
**⚠️ এখনো বাকি ২টা ছোট-স্কোপ আইটেম আগে পরিষ্কার করা উচিত**:
- `buildManualBackupData()` (Settings-এর ম্যানুয়াল export) — এখনো in-memory
  `products`-নির্ভর, synchronous, ২টা render call-site রিস্ট্রাকচার লাগবে
- `performMasterSync()`-এর Drive-বনাম-local merge লজিক — এখনো in-memory
  `products` তুলনার জন্য ব্যবহার করে, খালি হলে merge ভুল সিদ্ধান্ত নিতে পারে
