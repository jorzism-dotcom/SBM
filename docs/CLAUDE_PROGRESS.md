...
```
$ npm test                      → 17/17 suites, 265 cases, 0 failures
$ npm run lint                  → 0 errors, 577 warnings (App.jsx alone: 562 = HEAD baseline 562)
$ npm run typecheck             → clean
$ npm run build                 → ✓ built in 8.85s (after the DiagLog mirror)
